...
Rails.application.configure do
  ...
  config.hosts << "youauto-credit.ru"
  config.hosts << "www.youauto-credit.ru"
  ...
  # config.active_job.queue_name_prefix = "project_auto_production"
  ...
  # config.hosts = [
  #   "example.com",     # Allow requests fromhos example.com
  ...
  config.hosts << "www.#{ENV['HOST_NAME']}"
