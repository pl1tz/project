...
class ImportCarsService
  ...
  def delete_diff_cars
    Rails.logger.info("Start ImportCarsService.new.delete_diff_cars")
    url = 'https://app.plex-crm.ru/api/v3/offers/website/' + site_id.to_s
  ...
  def create_cars
    Rails.logger.info("Start ImportCarsService.new.create_cars")
    url = 'https://app.plex-crm.ru/api/v3/offers/website/' + site_id.to_s
  ...
  def update_cars
    Rails.logger.info("Start ImportCarsService.new.update_cars")
    url = 'https://app.plex-crm.ru/api/v3/offers/website/' + site_id.to_s
