...
class InstallmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create installment" do
    assert_difference("Installment.count") do
      post installments_url, params: { installment: { car_id: @installment.car_id, credit_term: @installment.credit_term, customer_car: @installment.customer_car, initial_contribution: @installment.initial_contribution, name: @installment.name, phone: @installment.phone } }
    end
  ...
  test "should update installment" do
    patch installment_url(@installment), params: { installment: { car_id: @installment.car_id, credit_term: @installment.credit_term, customer_car: @installment.customer_car, initial_contribution: @installment.initial_contribution, name: @installment.name, phone: @installment.phone } }
