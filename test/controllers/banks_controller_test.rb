...
class BanksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bank" do
    assert_difference("Bank.count") do
      post banks_url, params: { bank: { country: @bank.country, created_at: @bank.created_at, name: @bank.name } }
    end
  ...
  test "should update bank" do
    patch bank_url(@bank), params: { bank: { country: @bank.country, created_at: @bank.created_at, name: @bank.name } }
